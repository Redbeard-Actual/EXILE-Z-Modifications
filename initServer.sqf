private ["_timeStart","_timeSinceStart","_shutdownSuccess","_isDebug","_msg30mins","_msg15mins","_msg5mins","_timeUntilRestart","_60minspassed","_45minspassed","_30minspassed","_15minspassed","_5minspassed","_2minspassed","_60secondspassed"];
...
publicVariable "AGENomadTraderLoc";
...
while{true} do
{
	...
	switch true do
	{
		...
		{
			["toastRequest", ["ErrorTitleAndText", ["Server Restart", "60 seconds until server restart. LOG OUT NOW!!!"]]] call ExileServer_system_network_send_broadcast;
		...
		case ((_timeUntilRestart < (2 * 60)) && !_2minspassed) : 
		{
			["toastRequest", ["ErrorTitleAndText", ["Server Restart", "2 Minutes until server restart. LOG OUT NOW!!!"]]] call ExileServer_system_network_send_broadcast;
			diag_log "2 minutes until server restart.";
			_2minspassed = true;
			_5minspassed = true;
			_15minspassed = true;
			_30minspassed = true;
		...
		{
			["toastRequest", ["ErrorTitleAndText", ["Server Restart", "5 Minutes until server restart."]]] call ExileServer_system_network_send_broadcast;
			_5minspassed = true;
			_15minspassed = true;
			_30minspassed = true;
			_45minspassed = true;
		...
		{
			["toastRequest", ["ErrorTitleAndText", ["Server Restart", "15 Minutes until server restart."]]] call ExileServer_system_network_send_broadcast;
		...
		{
			["toastRequest", ["ErrorTitleAndText", ["Server Restart", "30 Minutes until server restart."]]] call ExileServer_system_network_send_broadcast;
			diag_log "30 minutes until server restart.";
			_30minspassed = true;
			_45minspassed = true;
			_60minspassed = true;
		};
		case ((_timeUntilRestart < (45 * 60)) && !_45minspassed) : 
		{
			["toastRequest", ["ErrorTitleAndText", ["Server Restart", "45 Minutes until server restart."]]] call ExileServer_system_network_send_broadcast;
			diag_log "45 minutes until server restart.";
			_45minspassed = true;
			_60minspassed = true;
		};
		case ((_timeUntilRestart < (60 * 60)) && !_60minspassed) : 
		{
			["toastRequest", ["ErrorTitleAndText", ["Server Restart", "60 Minutes until server restart."]]] call ExileServer_system_network_send_broadcast;
			diag_log "1 hour until server restart.";
			_60minspassed = true;
		};
	};
