...
class CfgExileArsenal
{
	...
	class Exile_Item_Knife  						{ quality = 1; price = 120; };
	...
	class H_HelmetO_ViperSP_hex_F     { quality = 4; price = 5000; };		//Themal
	class H_HelmetO_ViperSP_ghex_F    { quality = 4; price = 5000; }; 	//Themal
	...
	class Exile_Car_Lada_Taxi 				{ quality = 1; price = 1000; };
...
class CfgExileCustomCode 
{
	...
	*/
	ExileServer_object_player_network_createPlayerRequest = "custom\code\server\ExileServer_object_player_network_createPlayerRequest.sqf";
	ExileServer_object_player_createBambi = "custom\code\server\ExileServer_object_player_createBambi.sqf";
	ExileClient_action_hotwireVehicle_condition = "custom\code\client\ExileClient_action_hotwireVehicle_condition.sqf";
	ExileClient_action_hotwireVehicle_completed = "custom\code\client\ExileClient_action_hotwireVehicle_completed.sqf";
	...
	ExileClient_system_lootManager_thread_spawn = "custom\code\client\ExileClient_system_lootManager_thread_spawn.sqf";
};
...
class CfgExileLootSettings
{
	 ...
	 */
	minimumDistanceToTraderZones = 175;
	...
	*/
	...
	class ATM
    {
        ...
        class Actions
        {
            ...
            {
                title = "Deposit/Withdraw Poptabs";
                condition = "true";
